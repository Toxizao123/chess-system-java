...
public class UI {
	...
	public static ChessPosition readChessPosition(Scanner sc) {
		...
		try {
			...
			// recotar o string a partir da posição 1
	...
	public static void printMatch(ChessMatch chessMatch, List<ChessPiece> captured) {
		// o que será imprimir a partida?
		printBoard(chessMatch.getPieces()); // é imprimir o tabuleiro
		System.out.println();
	...
	// método para imprimir tabuleiro no console
